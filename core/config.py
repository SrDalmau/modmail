...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_auto_close_response": "Este ticket se ha cerrado automáticamente debido a la inactividad después de {timeout}.",
        "thread_creation_response": "El equipo del staff se comunicará con usted lo antes posible.",
        ...
        "thread_close_footer": "Si respondes se creará un nuevo ticket.",
        "thread_close_title": "Ticket Cerrado",
        "thread_close_response": "{closer.mention} ha cerrado el ticket.",
        "thread_self_close_response": "Usted ha cerrado este ticket.",
        ...
        "cooldown_thread_title": "¡El mensaje no ha sido enviado!",
        "cooldown_thread_response": "Debes esperar por {delta} antes de que puedas contactarme de nuevo.",
        "disabled_new_thread_title": "¡Mensaje no entregado!",
        "disabled_new_thread_response": "Actualmente no estamos aceptando tickets.",
        "disabled_new_thread_footer": "Por favor intente de nuevo más tarde...",
        "disabled_current_thread_title": "¡Mensaje no entregado!",
        "disabled_current_thread_response": "Actualmente no estamos aceptando mensajes.",
        "disabled_current_thread_footer": "¡Por favor intente de nuevo más tarde...",
        "transfer_reactions": True,
        "close_on_leave": False,
        "close_on_leave_reason": "El destinatario ha abandonado el servidor.",
        ...
        "confirm_thread_creation_title": "Confirmación del ticket.",
        "confirm_thread_response": "Reacciona para confirmar la creación del ticket.",
